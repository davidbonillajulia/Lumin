      ...
      >
        ...
        <div className="w-56 bg-obs-dark-1 border-r border-obs-border flex flex-col pt-4 shrink-0 justify-between">
          ...
          <div className="p-3 bg-obs-bg border-t border-obs-border sticky bottom-0 space-y-3 shrink-0">
            ...
            <div className="bg-obs-dark-1/50 border border-obs-text/5 p-2 rounded flex items-center justify-between mt-1">
              <div className="flex flex-col">
                <span className="text-[7px] text-obs-muted uppercase tracking-wider font-bold">VÍDEOS EN REPRODUCCIÓN</span>
                <span className="text-[10px] font-mono text-cyan-400 font-extrabold">{playingVideosCount} ACTIVO(S)</span>
              </div>
              <div className="flex items-center gap-1.5 bg-cyan-950/30 border border-cyan-500/10 px-2 py-1 rounded">
                <span className={`w-1.5 h-1.5 rounded-full bg-cyan-400 ${playingVideosCount > 0 ? 'animate-pulse' : 'opacity-40'}`} />
                <span className="text-[7px] text-cyan-400 font-black tracking-wider uppercase">
                  {playingVideosCount > 0 ? 'CASTING' : 'READY'}
                </span>
              </div>
            </div>
            <button
